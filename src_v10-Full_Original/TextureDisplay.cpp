...
void TextureDisplay::initialize() {
    std::cout << "TextureDisplay initialized (Full Original Mode)" << std::endl;
    ...
    std::cout << "Loading ALL 480 streaming assets!" << std::endl;
}
...
void TextureDisplay::update(sf::Time deltaTime) {
    ...
    if (ticks >= STREAMING_LOAD_DELAY) {
        ...
        int batchSize = 20;
        const int MAX_ICONS = 480;  // FULL ORIGINAL: 480!
