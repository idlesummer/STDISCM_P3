...
BaseRunner::BaseRunner() :
    window(sf::VideoMode(WINDOW_WIDTH, WINDOW_HEIGHT), "Minimal v6: Threading Basics", sf::Style::Close) {
    std::cout << "=== Minimal v6: Threading Basics ===" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "2. Icons will load on SEPARATE THREADS (asynchronous!)" << std::endl;
    std::cout << "3. Game continues smoothly while loading" << std::endl;
    std::cout << "4. Watch console for thread IDs!" << std::endl;
    std::cout << std::endl;
}
